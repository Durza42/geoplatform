...
int boucle_arcade (Var *var, Gal *gal) {
   ...
   while (1) {
      ...
      if (test_game_over_arcade (&fragms [fragm_act], var, gal))
         return 0;
...
bool test_game_over_arcade (Fragm *fragms, Var *var, Gal *gal) {
   ...
   if (coll_perso_pic_arcade (var, fragms)   ||
      ...
      print_message_arcade (var, gal, "game over", fragms);
...
void print_message_arcade (Var *var, Gal *gal, char *mess, Fragm *fragm) {
