...
#define NB_SOLSEC_LOCAL    6 // nombre de sols secondaires maximal des fragments de jeu
#define NB_DEADZONES_LOCAL 6 // nombre de zones de mort maximal des fragments de jeu

#define NB_FRAGMS_JEU 4 // nombre de fragments de jeu construits
...
bool test_game_over_arcade (Fragm *fragms, Var *var, Gal *gal);
...
void print_message_arcade (Var *var, Gal *gal, char *mess, Fragm *fragms);
